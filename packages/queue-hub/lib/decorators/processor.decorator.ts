...
import { PROCESSOR_METADATA, WORKER_METADATA } from '../queue-hub.constants';
 ...
 * @publicApi
 */
export function Processor(queueName: string, workerOptions: NestWorkerOptions): ClassDecorator;
 ...
 * @param workerOptions additional QueueHub worker options
 *
 * @publicApi
 */
